...
public class viewStudents extends GenericServlet {
	...
	public void service(ServletRequest rq, ServletResponse rs) throws ServletException, IOException {
		...
		out.print("<html>\r\n"
				...
				+ "<div class=\"text-info text-center txt-md\"><h2>Student Details</h2></div>    "
				);
...
out.println(""
					...
					+"<tr>"
						...
						+"<td>"
							+"<form action=\"http://localhost:8080/CollegeManagement/Updatestud\" method=\"post\">"
							+"<button type=\"submit\" style=\"border:none;\">"
								+"<i class=\"far fa-edit fa-sm\" style=\"color: blue;\"></i>"
								+"<input type=\"hidden\" name=\"studId\" value="+res.getString(1)+">"
							+"</button></form>"
						
							+"<form action=\"http://localhost:8080/CollegeManagement/deleteStud\" method=\"post\">"
							+"<button type=\"submit\" style=\"border:none;\">"
